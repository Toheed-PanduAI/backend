...
from util import  effect_images, transition_images
import random
import re
...
def generate_pan_left_to_right_video(image_path, output_video_path, zoom_step=1.1, crop_percent=0.75, frames=60, fps=10, frame_repeat=1, upscale_factor=2):
     # Load the image
    image = cv2.imread(image_path)
    ...
    # Upscale the image
    upscale_w, upscale_h = w * upscale_factor, h * upscale_factor
    image = cv2.resize(image, (upscale_w, upscale_h), interpolation=cv2.INTER_CUBIC)
    
    # Initialize the video writer
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')  # Codec
    out = cv2.VideoWriter(output_video_path, fourcc, fps, (upscale_w, upscale_h))
...
def generate_pan_right_to_left_video(image_path, output_video_path, zoom_step=1.1, crop_percent=0.75, frames=60, fps=10, frame_repeat=1, upscale_factor=2):
     # Load the image
    image = cv2.imread(image_path)
...
def generate_pan_top_to_bottom_video(image_path, output_video_path, zoom_step=1.1, crop_percent=0.75, frames=60, fps=10, frame_repeat=1, upscale_factor=2):
     # Load the image
    image = cv2.imread(image_path)
...
def generate_pan_bottom_to_top_video(image_path, output_video_path, zoom_step=1.1, crop_percent=0.75, frames=60, fps=10, frame_repeat=1, upscale_factor=2):
...
def generate_pan_top_left_to_bottom_right_video(image_path, output_video_path, zoom_step=1.1, crop_percent=0.75, frames=60, fps=10, frame_repeat=1, upscale_factor=2):
     # Load the image
    image = cv2.imread(image_path)
...
def generate_pan_bottom_right_to_top_left_video(image_path, output_video_path, zoom_step=1.1, crop_percent=0.75, frames=60, fps=10, frame_repeat=1, upscale_factor=2):
     # Load the image
    image = cv2.imread(image_path)
...
def generate_pan_bottom_left_to_top_right_video(image_path, output_video_path, zoom_step=1.1, crop_percent=0.75, frames=60, fps=10, frame_repeat=1, upscale_factor=2):
     # Load the image
    image = cv2.imread(image_path)
...
def generate_pan_top_right_to_bottom_left_video(image_path, output_video_path, zoom_step=1.1, crop_percent=0.75, frames=60, fps=10, frame_repeat=1, upscale_factor=2):
     # Load the image
    image = cv2.imread(image_path)
...
def generate_ken_burns_effect_video(image_path, output_video_path, start_zoom=1.0, end_zoom=2.0, pan_direction='right', frames=60, fps=30, frame_repeat=1, upscale_factor=2):
     # Load the image
    image = cv2.imread(image_path)
...
def stitch_videos_with_transition_old(input_video_folder, output_video_path, transition_function, transition_params):
...
# Example usage with Ken Burns effect
# api_key = 'sk-3F0GfWIwVs3Ns3efU5KjwhvF6dVDeKO2dncrVriVDgQGVc1a'
# prompt = 'A beautiful landscape with mountains and a river'
# negative_prompt = 'sky'
# aspect_ratio = '16:9'
# seed = 42
# output_format = 'png'
# output_video_path = 'ken_burns_effect.mp4'
